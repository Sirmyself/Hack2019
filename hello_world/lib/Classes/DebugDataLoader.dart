...
class DebugDataLoader implements IDataLoader {
  ...
  List<Activity> loadCityActivities(location) {
    ...
    Location loc = new Location("Le Terminal - Port de Québec", "84", "Dalhousie", "Vieux Quebec - Montcalm", "Quebec", "QC", "G1K 4C4", 46.816874, -71.200582);
    ...
    Location loc2 = new Location("Base de plein air de Sainte-Foy", "3180", "Rue Laberge", "La Suette", "Quebec", "QC", "G1X 4B3", 46.787251, -71.333421);
